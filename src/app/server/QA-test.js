...
const filteredData = Object.entries(dataSet[dataSet.length - 1]).filter(([key, value]) => key != "name" && key != "id" && key != "date" && key != "_id" && key != "__v" && key != "status" && key != "fullReport" && key != "duration" && value != '' && key != "featureName" && key != "technicalEntry" && key != "expectedResult");
